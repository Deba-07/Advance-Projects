    ...
    <section>
      <Element name="features">
        <div className="container">
          <div className="relative flex md:flex-wrap flex-nowrap border-2 border-s3 rounded-7xl md:overflow-hidden max-md:flex-col feature-after md:g7 max-md:rounded-none max-md:border-none max-md:gap-3">
            {features.map(({ id, icon, caption, title, text, button }) => (
              ...
              >
                ...
                <p className="caption mb-5 max-md:m-6">{caption}</p>
                <h2 className="max-w-400 mb-7 h-3 text-p4 max-md:mb-6 max-md:h-5 ">
                  {title}
                </h2>
